	...
	if (uchCPU == CPU1_ID)
		{
            switch(DAC_sysinfo.Unit_Type)
            {
                ...
                case DAC_UNIT_TYPE_SF:
                    ...
                    Count3.Byte.Lo = CPU1_data[Network_ID][55];
                    Count3.Byte.Hi = CPU1_data[Network_ID][55 + 1];                    
	...
	else
		{
            switch(DAC_sysinfo.Unit_Type)
            {
                ...
                case DAC_UNIT_TYPE_SF:
                    ...
                    Count3.Byte.Lo = CPU2_data[Network_ID][55];
                    Count3.Byte.Hi = CPU2_data[Network_ID][55 + 1];                    
